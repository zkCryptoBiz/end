( () => {
    ...
    let l = (t, e=!1, o=500, a=0) => {
        ...
        if (s) {
            ...
            if (e) {
                ...
                t.classList.contains("_header-scroll") ? l = t.offsetHeight : (t.style.cssText = "transition-duration: 0s;",
    ...
    document.addEventListener("keydown", (function(t) {
        document.documentElement.classList.contains("sound-play") || h || (h = !0,
        d.play(),
    ...
    document.getElementById("play-pause").addEventListener("click", ( () => {
        h || (h = !0),
        document.documentElement.classList.contains("sound-play") ? (d.pause(),
        document.documentElement.classList.remove("sound-play")) : (d.play(),
        document.documentElement.classList.add("sound-play"))
    }
    )),
    window.FLS = !1,
